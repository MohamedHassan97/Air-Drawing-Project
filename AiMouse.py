...
def AI_mouse_function(ai_mouse_flag):
    ...
    smoothening = 7
    #########################
    folderPath2 = "K:/ASU/Second Term/dip/shaf3i part/Header3"
